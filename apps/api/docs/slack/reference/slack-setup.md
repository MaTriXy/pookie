...
Complete guide for creating and configuring a Slack app for your Chat SDK agent.
...
**The webhook URL for Chat SDK is:**
...
**Note:** This manifest includes `reactions:read` and `reactions:write` scopes for the `onReaction` handler.
...
2. Check the URL is correct and accessible: includes `/api/webhooks/slack`
