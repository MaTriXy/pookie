...
2. **[Approve Plan](./1b-approve-plan.md)** — Review and approve custom implementation plan
3. **[Create Slack App](./2-create-slack-app.md)** — Customize manifest, create app in Slack
4. **[Configure Environment](./3-configure-environment.md)** — Set up `.env` with credentials
5. **[Test Locally](./4-test-locally.md)** — Dev server + ngrok tunnel
6. **[Deploy to Production](./5-deploy-production.md)** — Vercel deployment
7. **[Set Up Testing](./6-setup-testing.md)** — Vitest configuration (optional)
